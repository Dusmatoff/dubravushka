...
$text_parent_1 = get_field('text_parent_1');
$name_parent_1 = get_field('name_parent_1');
$desc_parent_1 = get_field('desc_parent_1');
$text_parent_2 = get_field('text_parent_2');
$name_parent_2 = get_field('name_parent_2');
$desc_parent_2 = get_field('desc_parent_2');
...
<?php endif; ?>
    ...
    <div class="text-review">
        <div class="text-review-block even">
            <div class="left">
                <p><?php echo $text_parent_1; ?></p>

                <p class="name"><?php echo $name_parent_1; ?></p>

                <p class="descr"><?php echo $desc_parent_1; ?></p>
            ...
            <div class="right">
                <div class="block-img">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/znak_otzyvy.png" />
                </div>
            </div>
        ...
        <div class="text-review-block odd">
            <div class="left">
                <div class="block-img">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/znak_otzyvy.png" />
                </div>
            ...
            <div class="right">
                <p><?php echo $text_parent_2; ?></p>

                <p class="name"><?php echo $name_parent_2; ?></p>

                <p class="descr"><?php echo $desc_parent_2; ?></p>
            </div>
